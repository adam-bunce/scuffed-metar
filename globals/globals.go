...
var Env = "prod"
var Version = "1.13.10" // for cache busting
...
var VersionHistory = []struct {
	...
	{SemVer: "v" + Version, Change: "limit metars for highways/cet2 to 10"},
	{SemVer: "v1.13.9", Change: "add cjr3"},
	{SemVer: "v1.13.8", Change: "cet2 tls error fix"},
